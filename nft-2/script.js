...
const modal__closse = document.querySelector('#close')
...
document.getElementById('telegramForm').addEventListener('submit', function (e) {
    ...
    const token = '7461316379:AAHUm_Af6nVSro9fnQ47UlSPCcPCOqR_IE0';  // Замените на ваш токен
    const chat_id = '-4593074289';  // Замените на ваш chat_id
    ...
    .then(data => {
      if (data.ok) {
        ...
        thanks.innerText = 'Спасибо за данные 😈'
